...
angular.module('farmbuild.webservices.examples.soilareaparser', ['farmbuild.farmdata','farmbuild.webservices.examples.soilareaparser'])
	...
	.controller('WfsAuthCtrl', function ($scope, $http, $log , farmdata, soilarea) {
